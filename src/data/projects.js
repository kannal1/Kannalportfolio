...
export const projects = [
  {
    ...
    groups: build('creb', [
      { key: 'overview', title: 'Overview', blurb: 'The shipped product, end to end.', files: [['creb-r-autorecur.png', 'Auto-investment plan'], ['creb-r-reinvest.png', 'Reinvesting earnings']] },
      { key: 'trust', title: 'Onboarding & trust', blurb: 'The scary first steps, sign in and link a bank, made to feel safe.', files: [['creb-r-signin.png', 'Sign in'], ['creb-r-otp.png', 'OTP verification'], ['creb-r-bank.png', 'Manage bank account']] },
      { key: 'invest', title: 'Invest & redeem', blurb: 'Buy bonds, deposit funds, watch interest compound.', files: [['creb-r-purchase.png', 'Purchase bonds'], ['creb-r-deposits.png', 'Deposits']] },
      { key: 'withdraw', title: 'Withdraw, every state', blurb: 'Confirm, success, failure. The states most people skip.', files: [['creb-r-withdraw.png', 'Withdraw'], ['creb-r-withdraw-success.png', 'Withdrawal successful'], ['creb-r-withdraw-failed.png', 'Withdrawal failed']] },
  ...
  },
  {
    ...
    groups: build('cgb', [
      { key: 'overview', title: 'Overview', blurb: 'A calmer, premium register for gold.', files: [['cgb-r-open.png', 'Open screen'], ['cgb-r-onboarding.png', 'Onboarding']] },
      { key: 'buy', title: 'Buy & customize', blurb: 'Shape an investment, then confirm with confidence.', files: [['cgb-r-buy.png', 'Buy bonds'], ['cgb-r-terms.png', 'Review and accept terms'], ['cgb-r-success.png', 'Purchase successful']] },
      { key: 'trust', title: 'Trust & banking', blurb: 'Deposits and banking, made reassuring.', files: [['cgb-r-deposits.png', 'Deposits and banking']] },
